...
def _carregar_base() -> pd.DataFrame:
    ...
    df["data"] = pd.to_datetime(df["data"], errors="coerce") # comentar decisao
...
def historico_cliente(cliente_id: str) -> dict:
    ...
    return {
        ...
        "5x_mediana_valor_brl": float(df_cliente["5x_mediana_brl"].iloc[0]),
...
def operacoes_do_dia(cliente_id: str, data: str) -> dict:
    ...
    return {
        ...
        "operacoes": df_dia[
            ["id", "valor_brl", "canal", "tipo", "contraparte"]
